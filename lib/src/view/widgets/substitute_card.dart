...
class ExtendedSubstituteCardState extends State<ExtendedSubstituteCard> {
  ...
  Widget build(BuildContext context) {
    ...
    timeOfLessons += " ${AppLocalizations.of(context)!.oclock}";
          ...
          children: [
            ...
            if (widget.substitute.substituteOf != null)
              ListTile(
                ...
                dense: true,
                title: Text(
                  "${AppLocalizations.of(context)!.substituteOf} ${widget.substitute.substituteOf!}",
                  style: const TextStyle(fontSize: 18),
                ),
              ),
...
class SubstituteMessageCard extends StatefulWidget {
  const SubstituteMessageCard({Key? key, required this.substituteMessage, required this.formatter})
      : super(key: key);
