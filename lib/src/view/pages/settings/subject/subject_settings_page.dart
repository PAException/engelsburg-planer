  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Document<Subject>>>(
      ...
      builder: (context, snapshot) {
        ...
        var data = snapshot.requireData.toList();
...
class _SubjectTileState extends State<SubjectTile> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
          ...
          : Center(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Subjects.get()
                      .entries
                      .add(Subject(baseSubject: widget.baseSubject.name))
                      .then((value) {
                    subject = value..load();
                    subject!.snapshots().listen((event) {
                      if (mounted) setState(() {});
                    });
                  });
      ...
      onTap: enabled ? () => context.pushPage(ExtendedSubjectPage(subject: subject!)) : null,
    );
  }
}
