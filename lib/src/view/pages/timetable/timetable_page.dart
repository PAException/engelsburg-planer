...
class TimetablePageState extends State<TimetablePage> {
  ...
  void initState() {
    ...
    Timetable.entries().defaultStorage(context).stream().listen((newEntries) async {
  ...
  Future<void> _toggleEdit() async {
    ...
    animating = Future.delayed(_kDuration);
              ...
              child: Column(
                ...
                children: [
                  ...
                  StreamBuilder<List<Document<TimetableEntry>>>(
                    stream: Timetable.entries().defaultStorage(context).stream(),
  ...
  List<Widget> _buildTimetable(List<Document<TimetableEntry>> timetable, DateTime date,
    ...
    for (var entry in entries) {
      ...
      var card = TimetableCard(
        entry: entry,
        date: date,
        entryDoc: docs.firstNullableWhere((element) => element.data!.sameTime(entry)),
        editing: _edit,
      );
      cards.add(card);
